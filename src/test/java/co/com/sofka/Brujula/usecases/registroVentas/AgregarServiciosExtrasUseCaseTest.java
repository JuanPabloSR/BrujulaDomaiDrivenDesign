...
class AgregarServiciosExtrasUseCaseTest {
    private static final String SERVICIOSEXTRAS_ID = "S-001";
    @Mock
    private DomainEventRepository repository;

    @Test
    @DisplayName("Test para probar la funcion a la hora de agregar un servicioextra a una venta")
    void agregarServicioExtraEnVenta() {
        //arrange
