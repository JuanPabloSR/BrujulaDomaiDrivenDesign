...
public class GuiaActualizado extends DomainEvent {
    ...
    public GuiaActualizado(SucursalBrujulaId sucursalBrujulaId, GuiaId guiaId, Nombre nombre, Celular celular, DeportePrincipal deportePrincipal) {
        super("sucursalbrujula.sucursal.guiaActualizado");
