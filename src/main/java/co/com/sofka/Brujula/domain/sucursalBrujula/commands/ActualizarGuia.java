...
public class ActualizarGuia extends Command {
    ...
    public ActualizarGuia(SucursalBrujulaId sucursalBrujulaId, GuiaId guiaId, Nombre nombre, Celular celular, DeportePrincipal deportePrincipal) {
